...
class Config:
    ...
    FORECAST_YEAR = '2035'
    RESULT_NAMING = {'USE_CUSTOM_ID': True, 'CUSTOM_ID': '950'}
    EXECUTION_FLAGS = {'RUN_TRAFFIC_CALCULATION': True,
        ...
        'DEBUG_MODE': False}
    CHARGING_CONFIG = {'STRATEGY': ['T_min', 'Konstant', 'Hub'],
        'ladequote': 0.8, 'power': '100-100-100', 'pause': '45-540'}
    MANUAL_CHARGER_COUNT = {'NCS': 4, 'HPC': 6, 'MCS': 2}
    MANUAL_DISTANCES = {'distribution_distance': 10,
        'transmission_distance': 9999999, 'powerline_distance': 9999999}
    DEFAULT_LOCATION = {'LONGITUDE': 6.60414, 'LATITUDE': 51.12994}
    ...
    TIME = {'WEEKS_PER_YEAR': None, 'RESOLUTION_MINUTES': None,
        'SIMULATION_HOURS': None, 'WEEK_MINUTES': None, 'TIMESTEPS_PER_DAY':
        None, 'TIMESTEPS_PER_WEEK': None}
    ...
    SUBSTATION_CONFIG = {'DISTRIBUTION': {'EXISTING_CAPACITY': 20000,
        'MAX_EXPANSION': 20000, 'EXPANSION_FIXED_COST': 500000},
        'TRANSMISSION': {'EXISTING_CAPACITY': 20000, 'MAX_EXPANSION': 20000,
